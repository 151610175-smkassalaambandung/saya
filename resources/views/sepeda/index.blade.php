		...
		<div class="col-md-12">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<p><a class="btn btn-primary" href="{{ route('sepeda.create') }}">Tambah</a></p>
					<table class="table">
						<thead>
							<tr>
								<th>Nama</th>
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="{{route('sepeda.edit', $data->id) }}" class="btn btn-primary">Ubah</a></td>

								<td>
									<form class="delete" action="{{route('sepeda.destroy', $data->id)}}" method="POST">
